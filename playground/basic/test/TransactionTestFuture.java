...
//
//    @Test
//    public void testTX1() throws BTChipException, UnreadableWalletException, IOException {
...
//
//        Transaction tx = new Transaction(params, TXIN_1);
//        Sha256Hash hash = Sha256Hash.wrap(ByteUtil.byteArray("edfe77f05b19741c8908a5a05cb15f3dd3f4d0029b38b659e98d8a4c10e00bb9"));
////        hash = tx.hashForSignature(0, txin_1.getInputs().elementAt(0).getScript(), Transaction.SigHash.ALL.byteValue());
//
////        System.out.println(hash);
//
////        ECKey.ECDSASignature sig = ECKey.ECDSASignature.decodeFromDER((ASN1Sequence.fromByteArray(signature)).getDEREncoded());
//
////        assertTrue(dk44H0H0H00.verify(hash, sig.toCanonicalised()));
//    }
//
//    @Test
...
//                txin_1.getOutputs().elementAt(1).getScript());
//        BTChipDongle.BTChipOutput output = dongle.finalizeInputFull(txout_1.serializeOutputs());
//        assertEquals(BTChipDongle.UserConfirmation.NONE, output.getUserConfirmation());
//
//        byte[] signature = dongle.untrustedHashSign("44'/0'/0'/0/0");
//        signature = canonicalizeSignature(signature);
//        byte[] originalSignature = Arrays.copyOfRange(txout_1.getInputs().elementAt(0).getScript(), 1, 1 + signature.length);
...
//            assertEquals(ISO7816.SW_SECURITY_STATUS_NOT_SATISFIED, e.getSW());
//        }
//    }
//
//    @Test
...
//        reset();
//        try {
//            dongle.untrustedHashSign("44'/0'/0'/0/0");
//            fail();
//        }
//        catch(BTChipException e) {
...
//        assertEquals(BTChipDongle.UserConfirmation.NONE, output.getUserConfirmation());
//        byte[] signature = dongle.untrustedHashSign("44'/0'/0'/0/1");
//        signature = canonicalizeSignature(signature);
//        byte[] originalSignature = Arrays.copyOfRange(txout_1.getInputs().elementAt(0).getScript(), 1, 1 + signature.length);
////        assertTrue(Arrays.equals(signature, originalSignature));
...
//        signature = dongle.untrustedHashSign("44'/0'/0'/0/1");
//        signature = canonicalizeSignature(signature);
...
//        // Card is removed from the field
//        try {
//            dongle.untrustedHashSign("44'/0'/0'/0/1");
//            fail();
//        }
//        catch(BTChipException e) {
//            assertEquals(e.getSW(), ISO7816.SW_CONDITIONS_NOT_SATISFIED);
...
//        BTChipDongle.BTChipOutput output = dongle.finalizeInputFull(txout_1.serializeOutputs());
//        assertEquals(BTChipDongle.UserConfirmation.NONE, output.getUserConfirmation());
//        byte[] signature = dongle.untrustedHashSign("45'/2147483647/0/0");
//        signature = canonicalizeSignature(signature);
